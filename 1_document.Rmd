...
Существует много разных пакетов, которые интегрируют возможности уже написанных java-script библиотек в R. Все это возможно благодоря пакету `htmlwidgets`, который соединяет R и JavaScript
